            ...
            <section className="resultsSection">
                ...
                <div className='result result2' id={location.state.seriesInfo.id}>
                    ...
                    <div className='resultInfos'>
                        ...
                        <p className="seriesSummary">{location.state.seriesInfo.summary? location.state.seriesInfo.summary : "No summary yet..."}</p>
                            ...
                            <div className="resultSeasons">
                                ...
                                <div className="menuDeroulant">  
                                    ...
                                    <div className='resultInfos InfosSeason'>
                                        ...
                                        {season.summary?  <div><h2 className="h2SummarySeason">Summary </h2> <p className="SummarySeason">{season.summary}</p></div> : "" }
